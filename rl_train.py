...
def main():
    ...
    if args.exp == 'AUTO':
        ...
        args.exp = f'{args.optim}, FadingMemory dynamic'                ################################ Here is the Legend Explanation ################################
    ...
    if is_koala:
        ...
        if args.optim == 'koala-v':
            ...
            extra_params['sigma'] = args.sigma
            extra_params['target_eps'] = args.target_eps
        else:
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if args.optim == 'koala-rl':
                    optimizer.state['target_eps'] = 1.0 * optimizer.state['target_eps']       # 1.0001
                optimizer.zero_grad()
                loss.backward()
